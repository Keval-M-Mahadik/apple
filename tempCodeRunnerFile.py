...
SUPPORT_USERNAME = '@torny_unlocked'

# ⚠️ REPLACE THESE WITH YOUR REAL IMEI PROVIDER DETAILS
...
# ⚠️ Put your 3 TronGrid API keys here (get them from https://www.trongrid.io/)
TRONGRID_API_KEYS = [
    '8628b901-103e-49d6-b1b3-ba197dd41fc8',   # Key 1
    'b4cd9a16-0d7e-4381-852f-d4b2381ea932',   # Key 2
    'ecdb360a-83e4-4047-98b9-41b0e8b9b3f9',   # Key 3
]
...
def verify_callback_owner(call):
    try:
        if call.message is None:
            # Fail closed — never trust a callback with no message
...
LANGUAGES = {
    'en': {
        ...
        'payment_info': "<b>{amount} {currency}</b>\nNetwork · TRON (TRC-20)\n\nRecipient's wallet address\n<blockquote><code>{pay_address}</code></blockquote>\n\nSend the payment within 30 minutes and click «Paid» to complete the payment",
    ...
    'es': {'welcome': "👋 <b>¡Bienvenido, {name}!</b>\n\n✅ <b>Estado de la cuenta:</b> Autorizado\n💰 <b>Saldo:</b> <code>{balance:.2f}$</code>\n🆔 <b>Tu ID:</b> <code>{user_id}</code>\n\nℹ️ <i>Para cualquier pregunta contacta a {support}</i>\n\n👇 <b>Selecciona un servicio para continuar:</b>", 'my_account': "👤 <b>Mi Cuenta</b>\n\n🆔 ID: <code>{user_id}</code>\n💰 Saldo: <code>{balance:.2f}$</code>", 'service_prompt': "🛒 <b>{service}</b>\n💲 Precio: <b>{price:.2f}$</b>\n\n✅ <b>Ingresa tu IMEI/SN:</b>", 'invalid_imei': "❌ IMEI/SN inválido. Ingresa un IMEI válido de 15 dígitos.", 'insufficient_balance': "❌ <b>¡Saldo insuficiente!</b>\nTu saldo: {balance:.2f}$\nRequerido: {price:.2f}$\n\nAgrega créditos usando /start.", 'processing': "⏳ <b>Procesando</b> {service} para IMEI: <code>{imei}</code>...", 'result': "✅ <b>Resultado para</b> <code>{imei}</code>\n\n📱 <b>Modelo:</b> {model}\n🔒 <b>FMI:</b> {fmi}\n☁️ <b>iCloud:</b> {icloud}\n📶 <b>Operador:</b> {carrier}", 'new_balance': "\n\n💰 <b>Nuevo saldo:</b> <code>{balance:.2f}$</code>", 'lang_select': "🌐 <b>Por favor selecciona tu idioma:</b>", 'lang_changed': "✅ ¡Idioma cambiado exitosamente!", 'btn_lang': "🌐 Idioma", 'btn_account': "👤 Mi Cuenta", 'more_info': "MÁS INFO", 'less_info': "MENOS INFO", 'please_choose_service': "Por favor elige un Servicio 👇", 'btn_back_menu': "⬅️ Volver al Menú", 'cancel_prompt': "❌ Acción cancelada. Volviendo al menú principal."},
    'ru': {'welcome': "👋 <b>Добро пожаловать, {name}!</b>\n\n✅ <b>Статус аккаунта:</b> Авторизован\n💰 <b>Баланс:</b> <code>{balance:.2f}$</code>\n🆔 <b>Ваш ID:</b> <code>{user_id}</code>\n\nℹ️ <i>По всем вопросам обращайтесь к {support}</i>\n\n👇 <b>Выберите услугу ниже:</b>", 'my_account': "👤 <b>Мой Аккаунт</b>\n\n🆔 ID: <code>{user_id}</code>\n💰 Баланс: <code>{balance:.2f}$</code>", 'service_prompt': "🛒 <b>{service}</b>\n💲 Цена: <b>{price:.2f}$</b>\n\n✅ <b>Введите ваш IMEI/SN:</b>", 'invalid_imei': "❌ Неверный IMEI/SN. Введите корректный 15-значный IMEI.", 'insufficient_balance': "❌ <b>Недостаточно средств!</b>\nВаш баланс: {balance:.2f}$\nТребуется: {price:.2f}$\n\nПополните баланс через /start.", 'processing': "⏳ <b>Обработка</b> {service} для IMEI: <code>{imei}</code>...", 'result': "✅ <b>Результат для</b> <code>{imei}</code>\n\n📱 <b>Модель:</b> {model}\n🔒 <b>FMI:</b> {fmi}\n☁️ <b>iCloud:</b> {icloud}\n📶 <b>Оператор:</b> {carrier}", 'new_balance': "\n\n💰 <b>Новый баланс:</b> <code>{balance:.2f}$</code>", 'lang_select': "🌐 <b>Пожалуйста, выберите язык:</b>", 'lang_changed': "✅ Язык успешно изменен!", 'btn_lang': "🌐 Язык", 'btn_account': "👤 Мой Аккаунт", 'more_info': "ПОДРОБНЕЕ", 'less_info': "СКРЫТЬ", 'please_choose_service': "Пожалуйста, выберите услугу 👇", 'btn_back_menu': "⬅️ Назад в меню", 'cancel_prompt': "❌ Действие отменено. Возврат в главное меню."},
    'hi': {'welcome': "👋 <b>स्वागत है, {name}!</b>\n\n✅ <b>खाता स्थिति:</b> अधिकृत\n💰 <b>शेष राशि:</b> <code>{balance:.2f}$</code>\n🆔 <b>आपकी आईडी:</b> <code>{user_id}</code>\n\nℹ️ <i>किसी भी प्रश्न के लिए {support} से संपर्क करें</i>\n\n👇 <b>जारी रखने के लिए नीचे एक सेवा चुनें:</b>", 'my_account': "👤 <b>मेरा खाता</b>\n\n🆔 आईडी: <code>{user_id}</code>\n💰 शेष राशि: <code>{balance:.2f}$</code>", 'service_prompt': "🛒 <b>{service}</b>\n💲 मूल्य: <b>{price:.2f}$</b>\n\n✅ <b>अपना IMEI/SN दर्ज करें:</b>", 'invalid_imei': "❌ अमान्य IMEI/SN। कृपया एक वैध 15-अंकीय IMEI दर्ज करें।", 'insufficient_balance': "❌ <b>अपर्याप्त शेष राशि!</b>\nआपकी शेष राशि: {balance:.2f}$\nआवश्यक: {price:.2f}$\n\nकृपया /start का उपयोग करके क्रेडिट जोड़ें।", 'processing': "⏳ <b>प्रसंस्करण</b> {service} IMEI के लिए: <code>{imei}</code>...", 'result': "✅ <b>परिणाम</b> <code>{imei}</code>\n\n📱 <b>मॉडल:</b> {model}\n🔒 <b>FMI:</b> {fmi}\n☁️ <b>iCloud:</b> {icloud}\n📶 <b>कैरियर:</b> {carrier}", 'new_balance': "\n\n💰 <b>नई शेष राशि:</b> <code>{balance:.2f}$</code>", 'lang_select': "🌐 <b>कृपया अपनी भाषा चुनें:</b>", 'lang_changed': "✅ भाषा सफलतापूर्वक बदली गई!", 'btn_lang': "🌐 भाषा", 'btn_account': "👤 मेरा खाता", 'more_info': "अधिक जानकारी", 'less_info': "कम जानकारी", 'please_choose_service': "कृपया सेवा चुनें 👇", 'btn_back_menu': "⬅️ मेनू पर वापस जाएं", 'cancel_prompt': "❌ कार्रवाई रद्द की गई। मुख्य मेनू पर वापस जा रहे हैं।"},
    'ar': {'welcome': "👋 <b>مرحباً، {name}!</b>\n\n✅ <b>حالة الحساب:</b> مصرح به\n💰 <b>الرصيد:</b> <code>{balance:.2f}$</code>\n🆔 <b>معرفك:</b> <code>{user_id}</code>\n\nℹ️ <i>لأي أسئلة اتصل بـ {support}</i>\n\n👇 <b>اختر خدمة أدناه للمتابعة:</b>", 'my_account': "👤 <b>حسابي</b>\n\n🆔 المعرف: <code>{user_id}</code>\n💰 الرصيد: <code>{balance:.2f}$</code>", 'service_prompt': "🛒 <b>{service}</b>\n💲 السعر: <b>{price:.2f}$</b>\n\n✅ <b>أدخل IMEI/SN الخاص بك:</b>", 'invalid_imei': "❌ IMEI/SN غير صالح. يرجى إدخال IMEI صالح مكون من 15 رقماً.", 'insufficient_balance': "❌ <b>رصيد غير كاف!</b>\nرصيدك: {balance:.2f}$\nالمطلوب: {price:.2f}$\n\nيرجى إضافة رصيد باستخدام /start.", 'processing': "⏳ <b>جاري المعالجة</b> {service} لـ IMEI: <code>{imei}</code>...", 'result': "✅ <b>نتيجة لـ</b> <code>{imei}</code>\n\n📱 <b>الطراز:</b> {model}\n🔒 <b>FMI:</b> {fmi}\n☁️ <b>iCloud:</b> {icloud}\n📶 <b>المشغل:</b> {carrier}", 'new_balance': "\n\n💰 <b>الرصيد الجديد:</b> <code>{balance:.2f}$</code>", 'lang_select': "🌐 <b>يرجى اختيار لغتك:</b>", 'lang_changed': "✅ تم تغيير اللغة بنجاح!", 'btn_lang': "🌐 اللغة", 'btn_account': "👤 حسابي", 'more_info': "مزيد من المعلومات", 'less_info': "أقل معلومات", 'please_choose_service': "الرجاء اختيار الخدمة 👇", 'btn_back_menu': "⬅️ العودة إلى القائمة", 'cancel_prompt': "❌ تم إلغاء الإجراء. العودة إلى القائمة الرئيسية."},
    'zh': {'welcome': "👋 <b>欢迎，{name}！</b>\n\n✅ <b>账户状态：</b> 已授权\n💰 <b>余额：</b> <code>{balance:.2f}$</code>\n🆔 <b>您的ID：</b> <code>{user_id}</code>\n\nℹ️ <i>如有任何问题，请联系 {support}</i>\n\n👇 <b>请选择下方的服务以继续：</b>", 'my_account': "👤 <b>我的账户</b>\n\n🆔 ID: <code>{user_id}</code>\n💰 余额: <code>{balance:.2f}$</code>", 'service_prompt': "🛒 <b>{service}</b>\n💲 价格: <b>{price:.2f}$</b>\n\n✅ <b>请输入您的 IMEI/SN：</b>", 'invalid_imei': "❌ IMEI/SN 无效。请输入有效的15位IMEI。", 'insufficient_balance': "❌ <b>余额不足！</b>\n您的余额: {balance:.2f}$\n需要: {price:.2f}$\n\n请使用 /start 添加余额。", 'processing': "⏳ <b>正在处理</b> {service}，IMEI: <code>{imei}</code>...", 'result': "✅ <b>结果</b> <code>{imei}</code>\n\n📱 <b>型号:</b> {model}\n🔒 <b>FMI:</b> {fmi}\n☁️ <b>iCloud:</b> {icloud}\n📶 <b>运营商:</b> {carrier}", 'new_balance': "\n\n💰 <b>新余额:</b> <code>{balance:.2f}$</code>", 'lang_select': "🌐 <b>请选择您的语言：</b>", 'lang_changed': "✅ 语言更改成功！", 'btn_lang': "🌐 语言", 'btn_account': "👤 我的账户", 'more_info': "更多信息", 'less_info': "收起信息", 'please_choose_service': "请选择服务 👇", 'btn_back_menu': "⬅️ 返回主菜单", 'cancel_prompt': "❌ 操作已取消。返回主菜单。"},
    'fr': {'welcome': "👋 <b>Bienvenue, {name} !</b>\n\n✅ <b>Statut du compte :</b> Autorisé\n💰 <b>Solde :</b> <code>{balance:.2f}$</code>\n🆔 <b>Votre ID :</b> <code>{user_id}</code>\n\nℹ️ <i>Pour toute question, contactez {support}</i>\n\n👇 <b>Sélectionnez un service ci-dessous :</b>", 'my_account': "👤 <b>Mon Compte</b>\n\n🆔 ID: <code>{user_id}</code>\n💰 Solde: <code>{balance:.2f}$</code>", 'service_prompt': "🛒 <b>{service}</b>\n💲 Prix: <b>{price:.2f}$</b>\n\n✅ <b>Entrez votre IMEI/SN :</b>", 'invalid_imei': "❌ IMEI/SN invalide. Veuillez entrer un IMEI valide de 15 chiffres.", 'insufficient_balance': "❌ <b>Solde insuffisant !</b>\nVotre solde: {balance:.2f}$\nRequis: {price:.2f}$\n\nVeuillez ajouter des crédits via /start.", 'processing': "⏳ <b>Traitement</b> {service} pour IMEI: <code>{imei}</code>...", 'result': "✅ <b>Résultat pour</b> <code>{imei}</code>\n\n📱 <b>Modèle:</b> {model}\n🔒 <b>FMI:</b> {fmi}\n☁️ <b>iCloud:</b> {icloud}\n📶 <b>Opérateur:</b> {carrier}", 'new_balance': "\n\n💰 <b>Nouveau solde :</b> <code>{balance:.2f}$</code>", 'lang_select': "🌐 <b>Veuillez sélectionner votre langue :</b>", 'lang_changed': "✅ Langue changée avec succès !", 'btn_lang': "🌐 Langue", 'btn_account': "👤 Mon Compte", 'more_info': "PLUS D'INFO", 'less_info': "MOINS D'INFO", 'please_choose_service': "Veuillez choisir un service 👇", 'btn_back_menu': "⬅️ Retour au Menu", 'cancel_prompt': "❌ Action annulée. Retour au menu principal."},
    'de': {'welcome': "👋 <b>Willkommen, {name}!</b>\n\n✅ <b>Kontostatus:</b> Autorisiert\n💰 <b>Guthaben:</b> <code>{balance:.2f}$</code>\n🆔 <b>Ihre ID:</b> <code>{user_id}</code>\n\nℹ️ <i>Bei Fragen kontaktieren Sie {support}</i>\n\n👇 <b>Wählen Sie unten einen Service:</b>", 'my_account': "👤 <b>Mein Konto</b>\n\n🆔 ID: <code>{user_id}</code>\n💰 Guthaben: <code>{balance:.2f}$</code>", 'service_prompt': "🛒 <b>{service}</b>\n💲 Preis: <b>{price:.2f}$</b>\n\n✅ <b>Geben Sie Ihre IMEI/SN ein:</b>", 'invalid_imei': "❌ Ungültige IMEI/SN. Bitte geben Sie eine gültige 15-stellige IMEI ein.", 'insufficient_balance': "❌ <b>Unzureichendes Guthaben!</b>\nIhr Guthaben: {balance:.2f}$\nErforderlich: {price:.2f}$\n\nBitte laden Sie Guthaben über /start auf.", 'processing': "⏳ <b>Verarbeitung</b> {service} für IMEI: <code>{imei}</code>...", 'result': "✅ <b>Ergebnis für</b> <code>{imei}</code>\n\n📱 <b>Modell:</b> {model}\n🔒 <b>FMI:</b> {fmi}\n☁️ <b>iCloud:</b> {icloud}\n📶 <b>Anbieter:</b> {carrier}", 'new_balance': "\n\n💰 <b>Neues Guthaben:</b> <code>{balance:.2f}$</code>", 'lang_select': "🌐 <b>Bitte wählen Sie Ihre Sprache:</b>", 'lang_changed': "✅ Sprache erfolgreich geändert!", 'btn_lang': "🌐 Sprache", 'btn_account': "👤 Mein Konto", 'more_info': "MEHR INFO", 'less_info': "WENIGER INFO", 'please_choose_service': "Bitte wählen Sie einen Service 👇", 'btn_back_menu': "⬅️ Zurück zum Menü", 'cancel_prompt': "❌ Aktion abgebrochen. Zurück zum Hauptmenü."},
    'pt': {'welcome': "👋 <b>Bem-vindo, {name}!</b>\n\n✅ <b>Status da Conta:</b> Autorizado\n💰 <b>Saldo:</b> <code>{balance:.2f}$</code>\n🆔 <b>Seu ID:</b> <code>{user_id}</code>\n\nℹ️ <i>Para qualquer dúvida contacte {support}</i>\n\n👇 <b>Selecione um serviço abaixo:</b>", 'my_account': "👤 <b>Minha Conta</b>\n\n🆔 ID: <code>{user_id}</code>\n💰 Saldo: <code>{balance:.2f}$</code>", 'service_prompt': "🛒 <b>{service}</b>\n💲 Preço: <b>{price:.2f}$</b>\n\n✅ <b>Insira seu IMEI/SN:</b>", 'invalid_imei': "❌ IMEI/SN inválido. Por favor, insira um IMEI válido de 15 dígitos.", 'insufficient_balance': "❌ <b>Saldo insuficiente!</b>\nSeu saldo: {balance:.2f}$\nNecessário: {price:.2f}$\n\nAdicione créditos usando /start.", 'processing': "⏳ <b>Processando</b> {service} para IMEI: <code>{imei}</code>...", 'result': "✅ <b>Resultado para</b> <code>{imei}</code>\n\n📱 <b>Modelo:</b> {model}\n🔒 <b>FMI:</b> {fmi}\n☁️ <b>iCloud:</b> {icloud}\n📶 <b>Operadora:</b> {carrier}", 'new_balance': "\n\n💰 <b>Novo Saldo:</b> <code>{balance:.2f}$</code>", 'lang_select': "🌐 <b>Por favor, selecione seu idioma:</b>", 'lang_changed': "✅ Idioma alterado com sucesso!", 'btn_lang': "🌐 Idioma", 'btn_account': "👤 Minha Conta", 'more_info': "MAIS INFO", 'less_info': "MENOS INFO", 'please_choose_service': "Por favor, escolha um serviço 👇", 'btn_back_menu': "⬅️ Voltar ao Menu", 'cancel_prompt': "❌ Ação cancelada. Voltando ao menu principal."},
    'tr': {'welcome': "👋 <b>Hoş geldin, {name}!</b>\n\n✅ <b>Hesap Durumu:</b> Yetkili\n💰 <b>Bakiye:</b> <code>{balance:.2f}$</code>\n🆔 <b>Kimliğiniz:</b> <code>{user_id}</code>\n\nℹ️ <i>Herhangi bir sorunuz için {support} ile iletişime geçin</i>\n\n👇 <b>Devam etmek için aşağıdan bir hizmet seçin:</b>", 'my_account': "👤 <b>Hesabım</b>\n\n🆔 ID: <code>{user_id}</code>\n💰 Bakiye: <code>{balance:.2f}$</code>", 'service_prompt': "🛒 <b>{service}</b>\n💲 Fiyat: <b>{price:.2f}$</b>\n\n✅ <b>IMEI/SN girin:</b>", 'invalid_imei': "❌ Geçersiz IMEI/SN. Lütfen 15 haneli geçerli bir IMEI girin.", 'insufficient_balance': "❌ <b>Yetersiz bakiye!</b>\nBakiyeniz: {balance:.2f}$\nGerekli: {price:.2f}$\n\nLütfen /start kullanarak kredi ekleyin.", 'processing': "⏳ <b>İşleniyor</b> {service} IMEI: <code>{imei}</code>...", 'result': "✅ <b>Sonuç</b> <code>{imei}</code>\n\n📱 <b>Model:</b> {model}\n🔒 <b>FMI:</b> {fmi}\n☁️ <b>iCloud:</b> {icloud}\n📶 <b>Operatör:</b> {carrier}", 'new_balance': "\n\n💰 <b>Yeni Bakiye:</b> <code>{balance:.2f}$</code>", 'lang_select': "🌐 <b>Lütfen dilinizi seçin:</b>", 'lang_changed': "✅ Dil başarıyla değiştirildi!", 'btn_lang': "🌐 Dil", 'btn_account': "👤 Hesabım", 'more_info': "DAHA FAZLA", 'less_info': "DAHA AZ", 'please_choose_service': "Lütfen Hizmet Seçin 👇", 'btn_back_menu': "⬅️ Menüye Dön", 'cancel_prompt': "❌ İşlem iptal edildi. Ana menüye dönülüyor."}
}
...
def main_menu(lang, is_admin_flag=False):
    ...
    buttons = []
    for key_ in SERVICES:
        data = SERVICES[key_]
        buttons.append(data["name"].get(lang, data["name"]["en"]))
    buttons.append(get_text(lang, 'btn_lang'))
    buttons.append(get_text(lang, 'btn_account'))
    buttons.append(get_text(lang, 'btn_support'))
    if is_admin_flag:
...
def paid_button_kb(lang, deposit_id):
    markup = types.InlineKeyboardMarkup(row_width=2)
    markup.add(
        types.InlineKeyboardButton(get_text(lang, 'btn_cancel_pay'), callback_data=f"dep_cancel_{deposit_id}"),
        types.InlineKeyboardButton(get_text(lang, 'btn_paid_pay'), callback_data=f"paid_{deposit_id}")
    )
    return markup
...
def cancel_command(message):
    ...
    # Generic cancel message; falls back to English if the key is missing
...
def send_welcome(message):
    ...
    if user_id not in ADMIN_IDS:
        ...
        if maint == 'on':
            bot.send_message(user_id, "⚠️ <b>Bot is currently under maintenance.</b>\n\nWe are updating our systems. Please try again later.", parse_mode='HTML')
            return
    clear_pending(user_id)
    try:
        bot.clear_step_handler_by_chat_id(message.chat.id)
...
def my_account(message):
    ...
    if user_id not in ADMIN_IDS:
        maint = get_bot_setting('maintenance')
        if maint == 'on':
            bot.send_message(user_id, "⚠️ <b>Bot is currently under maintenance.</b>", parse_mode='HTML')
            return
    clear_pending(user_id)
    balance, lang = get_user(user_id)
    markup = types.InlineKeyboardMarkup()
...
def support_handler(message):
    ...
    _, lang = get_user(user_id)
    is_adm = user_id in ADMIN_IDS
    bot.send_message(user_id, f"🆘 <b>Support</b>\n\nContact: {SUPPORT_USERNAME}", reply_markup=main_menu(lang, is_adm))
...
def admin_review_deposit(call):
    ...
    # Use the user's actual language for notifications
...
def admin_start(message):
    if not is_admin(message.from_user.id):
        ...
        return
    admin_bot.send_message(message.chat.id, "👑 <b>Admin Control Panel</b>\n\nUse the buttons below to manage users.", reply_markup=admin_main_menu())
...
def admin_maintenance_menu(message):
    ...
    text = f"🛠️ <b>Maintenance Mode</b>\n\nCurrent status: <b>{current.upper()}</b>\n\nTurning this ON will block all non-admin users from using the bot."
    markup = types.InlineKeyboardMarkup(row_width=2)
    markup.add(
        types.InlineKeyboardButton("✅ Turn ON", callback_data="maint_on"),
        types.InlineKeyboardButton("❌ Turn OFF", callback_data="maint_off")
    )
...
def admin_maintenance_toggle(call):
    ...
    admin_bot.answer_callback_query(call.id, f"✅ Maintenance mode turned {state.upper()}")
    text = f"🛠️ <b>Maintenance Mode</b>\n\nCurrent status: <b>{state.upper()}</b>\n\nTurning this ON will block all non-admin users from using the bot."
    try:
        admin_bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text=text, reply_markup=call.message.reply_markup, parse_mode='HTML')
    except Exception:
        pass
...
def admin_stats(message):
    if not is_admin(message.from_user.id): return
    users = get_total_users(); bal = get_total_balance()
    avg = bal / users if users else 0
    admin_bot.send_message(message.chat.id, f"📊 <b>Bot Statistics</b>\n\n👥 Users: <b>{users}</b>\n💰 Total balance: <b>{bal:.2f}$</b>\n📈 Average: <b>{avg:.2f}$</b>", reply_markup=admin_main_menu())
